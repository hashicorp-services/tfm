...
| Reference | Purpose |
|-----------|---------|
| `go-development/references/architecture.md` | Package structure, config management, middleware chains |
| `go-development/references/logging.md` | Structured logging with log/slog, migration from logrus |
| `go-development/references/cron-scheduling.md` | go-cron patterns: named jobs, runtime updates, context, resilience |
| `go-development/references/resilience.md` | Retry logic, graceful shutdown, context propagation |
| `go-development/references/docker.md` | Docker client patterns, buffer pooling |
| `go-development/references/ldap.md` | LDAP/Active Directory integration |
| `go-development/references/testing.md` | Test strategies, build tags, table-driven tests |
| `go-development/references/linting.md` | golangci-lint v2, staticcheck, code quality |
| `go-development/references/api-design.md` | Bitmask options, functional options, builders |
| `go-development/references/fuzz-testing.md` | Go fuzzing patterns, security seeds |
| `go-development/references/mutation-testing.md` | Gremlins configuration, test quality measurement |
| `go-development/references/makefile.md` | Standard Makefile interface for CI/CD |
| `go-development/references/modernization.md` | Go 1.26 modernizers, `go fix`, `errors.AsType[T]`, `wg.Go()` |
